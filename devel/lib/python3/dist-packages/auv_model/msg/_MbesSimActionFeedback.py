...
"""autogenerated by genpy from auv_model/MbesSimActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MbesSimActionFeedback(genpy.Message):
  _md5sum = "bc3bd381eeed326615699b4304f39a7a"
  _type = "auv_model/MbesSimActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','auv_model/MbesSimFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MbesSimActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = auv_model.msg.MbesSimFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = auv_model.msg.MbesSimFeedback()
