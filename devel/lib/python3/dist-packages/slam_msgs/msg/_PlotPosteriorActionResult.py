...
"""autogenerated by genpy from slam_msgs/PlotPosteriorActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlotPosteriorActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "slam_msgs/PlotPosteriorActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','slam_msgs/PlotPosteriorResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlotPosteriorActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = slam_msgs.msg.PlotPosteriorResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = slam_msgs.msg.PlotPosteriorResult()
