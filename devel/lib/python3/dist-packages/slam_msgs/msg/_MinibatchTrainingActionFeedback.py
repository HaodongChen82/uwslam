...
"""autogenerated by genpy from slam_msgs/MinibatchTrainingActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MinibatchTrainingActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "slam_msgs/MinibatchTrainingActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','slam_msgs/MinibatchTrainingFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MinibatchTrainingActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = slam_msgs.msg.MinibatchTrainingFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = slam_msgs.msg.MinibatchTrainingFeedback()
